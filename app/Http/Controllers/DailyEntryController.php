...
class DailyEntryController extends Controller
{
    ...
    {
        // Verify the parent entry belongs to the authenticated user before deleting.
        // EntryItem has no UserScope (it has no user_id column), so we check
        // ownership via its parent DailyEntry which IS scoped.
        $entry = DailyEntry::findOrFail($entryItem->daily_entry_id);
        // Add this — abort if the entry doesn't belong to the authenticated user
