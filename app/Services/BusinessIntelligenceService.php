...
class BusinessIntelligenceService
{
    ...
    public function getRecommendations(): array
    {
        $recs       = [];
        $comparison = $this->analyticsService->getUsageComparison();
        $byReason   = $this->analyticsService->getUsageComparisonByReason()
    ...
    {
        $items = $this->analyticsService->getUsageComparisonByReason();
        ...
        $allItems   = $this->analyticsService->getUsageComparison();
    ...
    public function getItemPerformanceIntelligence(): Collection
{
        ...
        return $this->analyticsService->getUsageComparison()
    ...
    public function getImpactEstimation(): array
    {
        ...
        $currentLoss = $this->analyticsService->getUsageComparison()->sum('wasted_value');
