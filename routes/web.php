...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('storage', StorageController::class)
        ->parameters(['storage' => 'storageItem']);
    Route::patch('/storage/{storageItem}/deplete', [StorageController::class, 'deplete'])
        ->name('storage.deplete');
    Route::patch('/storage/{storageItem}/restore', [StorageController::class, 'restore'])
