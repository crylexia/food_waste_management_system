...
<div class="kpi-row" style="margin-bottom:20px;">
    ...
    <div class="a-card kpi-card">
        ...
        <div class="kpi-value c-success">{{ number_format($entry->entryItems->sum('used_quantity'), 2) }}</div>
        <div class="kpi-hint">units consumed</div>
    </div>
    <div class="a-card kpi-card">
...
<div class="a-card">
    <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:14px;">
        <div>
            ...
            <p class="section-desc" style="margin:3px 0 0;">{{ $entry->entryItems->count() }} item{{ $entry->entryItems->count() !== 1 ? 's' : '' }} in this entry</p>
        </div>
    </div>
    ...
    @if($entry->entryItems->count() > 0)
        ...
        <div style="margin-top:16px; padding:14px 16px; background:#f8fafc; border-radius:8px; font-size:13px; color:#555; display:flex; gap:24px;">
            <span><strong style="color:#111;">Used:</strong> {{ number_format($entry->entryItems->sum('used_quantity'), 2) }}</span>
            <span><strong style="color:#111;">Wasted:</strong> {{ number_format($entry->entryItems->sum('wasted_quantity'), 2) }}</span>
...
@media (max-width: 1024px) {
    .entry-form-grid { grid-template-columns:1fr 1fr; }
